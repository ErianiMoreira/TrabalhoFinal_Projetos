 ...
 */
@Deprecated
public class FrameManterUsuariosView extends javax.swing.JFrame {

	/** Creates new form ManterUsuariosView */
	public FrameManterUsuariosView() {
		initComponents();
	}
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1026, 302));
        ...
        tblListaUsuarios.setPreferredSize(new java.awt.Dimension(1014, 90));
